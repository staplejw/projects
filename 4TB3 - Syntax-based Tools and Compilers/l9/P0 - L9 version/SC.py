...
BEGIN = 39; PROGRAM = 40; EOF = 41; TILDE = 42; AMP = 43
BAR = 44
...
def singleLineComment():
    while chr(0) != ch != '\n': getChar() # single line comments can be terminated by a newline character
    if ch == chr(0): # means that the comment is on the last line of code and the file has ended
    else: getChar() # means the comment has been termined by a newline character, continue parsing
