...
public class BfsPathTest {
	...
	// iterate through every vertex and check that it has been marked during bfs. this shows that all cities have been examined/explored
	@Test
	public void testallCitiesVisited() {
		for (int v = 0; v < Digraph.V(); v++) {
			assertTrue(b.getMarked(v));
		}
	}
	...
	public void testvalidPath() {
		Iterator<Integer> I1 = b.pathTo(Digraph.getST().get("MINNEAPOLIS")).iterator(); // iterator for first vertex
		Iterator<Integer> I2 = b.pathTo(Digraph.getST().get("MINNEAPOLIS")).iterator(); // iterator for second vertex
